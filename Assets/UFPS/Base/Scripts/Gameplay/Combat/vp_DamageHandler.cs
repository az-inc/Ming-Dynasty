...
public class vp_DamageHandler : MonoBehaviour
	public player.playerobject PlayerObj = new Player.playerobject;
{
	...
	public virtual void Damage(float damage)
	{
		...
		if (PlayerObj.health[0] <= 0.0f)
			return;

		PlayerObj.health[0] = Mathf.Min(PlayerObj.health[0] - damage, MaxHealth);
